    ...
    <div className="w-full h-screen bg-brand-bg relative overflow-hidden flex flex-col">
      ...
      >
        ...
        <div className="min-w-[300vw] min-h-[300vh] flex items-center justify-center p-[400px] md:p-[800px]">
          <div ref={gridRef} className="grid grid-cols-5 gap-x-[150px] md:gap-x-[180px] lg:gap-x-[240px] gap-y-[100px] md:gap-y-[120px] lg:gap-y-[140px] w-max">
            {items.map((item) => (
              <div
                key={item.id}
              ...
              >
                ...
                {!isMobile && (
                  <div 
                    className={`absolute left-full top-0 ml-4 md:ml-6 lg:ml-8 z-[100] transition-all duration-500 w-[80px] md:w-[150px] lg:w-[190px] pointer-events-none ${
